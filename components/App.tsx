...
import {Nav, TPrimaryNavEntry, TSecondaryNavEntry} from './Nav';
...
export function App(){
  console.log('turkeyman has returned')
  const [primaryNavId, setPrimaryNavId] = React.useState(primaryNavEntries[0].id);
  const handleClickPrimary = (id: string) => {
    console.log('handleClickPrimary =>', id);
    setPrimaryNavId(id);
  }
  return(
    <div>
    ...
    <div className="container">
      <Nav
        ...
        secondaryNavEntries={secondaryNavEntries[primaryNavId]}
        primarySelectedId={primaryNavId}
